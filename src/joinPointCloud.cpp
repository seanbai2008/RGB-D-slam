...
int main( int argc, char** argv )
{
    ...
    //读取图像
    frame1.rgb = cv::imread( "/home/fan/test_dir/develop/src/RGB-D/src/data/rgb1.png" );
    frame1.depth = cv::imread( "/home/fan/test_dir/develop/src/RGB-D/src/data/depth1.png", -1);
    frame2.rgb = cv::imread( "/home/fan/test_dir/develop/src/RGB-D/src/data/rgb2.png" );
    frame2.depth = cv::imread( "/home/fan/test_dir/develop/src/RGB-D/src/data/depth2.png", -1 );
    ...
    _descriptor = cv::AKAZE::create();

    // string detecter = pd.getData( "detector" );
    // string descriptor = pd.getData( "descriptor" );

    computeKeyPointsAndDesp( frame1, _detector, _descriptor );
    computeKeyPointsAndDesp( frame2, _detector, _descriptor );
