...
int main( int argc, char** argv )
{
    ...
    cv::Mat rgb1 = cv::imread("/home/fan/test_dir/develop/src/RGB-D/src/data/rgb.png");
    cv::Mat rgb2 = cv::imread( "/home/fan/test_dir/develop/src/RGB-D/src/data/rgb2.png");
    cv::Mat depth1 = cv::imread("/home/fan/test_dir/develop/src/RGB-D/src/data/depth.png", -1);
    ...
    vector< cv::KeyPoint > kp1, kp2; //关键点 detect the features
    ...
    // cout<<pts_img<<endl;
    // 求解pnp
    cv::solvePnPRansac( pts_obj, pts_img, cameraMatrix, cv::Mat(), rvec, tvec, false, 300, 1.0, 0.99, inliers,cv::SOLVEPNP_ITERATIVE );
