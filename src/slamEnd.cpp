...
int main( int argc, char** argv )
{
    ...
    *******************************/
    ...
    globalOptimizer.save("/home/fan/test_dir/develop/src/RGB-D/src/data/result_before.g2o");
    globalOptimizer.initializeOptimization();
    globalOptimizer.optimize( 100 ); //可以指定优化步数
    globalOptimizer.save( "/home/fan/test_dir/develop/src/RGB-D/src/data/result_after.g2o" );
    ...
    voxel.filter( *tmp );
    //存储
    pcl::io::savePCDFile( "/home/fan/test_dir/develop/src/RGB-D/src/pointcloud.pcd", *tmp );
